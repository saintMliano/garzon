...
- **F5 (turno autónomo), F6 (cierre de caja) y F7 (rendimiento) completas.** El roadmap se reordenó el 2026-08-10 (`plan/AUDITORIA-2026-08-10.md`): "dominios propios" pasó al final. **La fase siguiente es F8 — confianza**: idempotencia de `crear_pedido` (`client_request_id`), auditoría de cambios de estado y defensa anti-abuso en el checkout.
