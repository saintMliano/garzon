...
- **F5 (turno autónomo) y F6 (cierre de caja) completas.** El roadmap se reordenó el 2026-08-10 (`plan/AUDITORIA-2026-08-10.md`): "dominios propios" pasó al final. **La fase siguiente es F7 — rendimiento percibido**: menú a Server Component + `generateMetadata`, refresco del menú y reconciliación de precios del carrito. Medido: el menú tarda 0,4-1,1 s de consultas *desde fibra*; en 4G real son 3-6 s hasta ver la carta.
