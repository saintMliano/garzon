...
- **F5 a F9 completas** (turno autónomo, cierre de caja, rendimiento, confianza, marca). El roadmap se reordenó el 2026-08-10 (`plan/AUDITORIA-2026-08-10.md`): "dominios propios" pasó al final. **La fase siguiente es F10 — negocio**: propina sugerida, planes/suscripción, pago en línea.
